      ...
      <main
        ...
        <div class="p-4 border-b border-slate-200 dark:border-slate-800">
          ...
          <div class="relative group">
            ...
            <input
              class="w-full bg-slate-100 dark:bg-slate-800 border-none rounded-xl py-2.5 pl-10 pr-4 text-sm focus:ring-2 focus:ring-primary/50 transition-all placeholder:text-slate-400"
              placeholder="Search clients..." type="text" />
          </div>
        </div>
        <div class="flex gap-2 p-4 overflow-x-auto scrollbar-hide">
          <button
            class="px-4 py-1.5 rounded-full bg-primary text-slate-900 text-xs font-semibold whitespace-nowrap">All</button>
          <button
            class="px-4 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 text-xs font-semibold whitespace-nowrap hover:bg-slate-200 dark:hover:bg-slate-700">Unread</button>
          <button
            class="px-4 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 text-xs font-semibold whitespace-nowrap hover:bg-slate-200 dark:hover:bg-slate-700">High
            Priority</button>
          <button
            class="px-4 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 text-xs font-semibold whitespace-nowrap hover:bg-slate-200 dark:hover:bg-slate-700">New
            Activity</button>
        </div>
        <div class="flex-1 overflow-y-auto scrollbar-hide">
          ...
          <div class="p-4 flex items-start gap-4 bg-primary/5 border-l-4 border-primary cursor-pointer">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-xs text-slate-500 dark:text-slate-400 truncate mt-0.5">I just finished the upper body
                session, feeling great!</p>
              <div class="mt-2">
                <span
                  class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-primary/20 text-primary-dark uppercase">Training
                  Now</span>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div class="relative shrink-0">
              <img class="h-12 w-12 rounded-full object-cover" data-alt="Client profile image of James"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuA9JPE2Px7eJ14x1TflpAd3F8cnacmElthT4tRzPrcpD9agQoNBTCT9Nz37TBaMUbQclR_qWWvtVo611HJPOl5fy5wX3a-pcSDhiYOLVrOvf-bqq6qZemYqcx-T51vnLHHp1liXip3b4GdtyqVpx8BegVaWzjjS-MhXGD-Prq2dBlUMwWCUdLrgeDGi99TaH5zCiYx_BiMlW5q48tjPC_oGJ431nznxoapu3v6ILROlw-2MDAWfxAAv6ekeRTdp38VbCO6-5Rnuuao" />
            </div>
            <div class="flex-1 min-w-0">
              <div class="flex justify-between items-baseline">
              ...
              <p class="text-xs text-slate-500 dark:text-slate-400 truncate mt-0.5">Can we reschedule tomorrow's session
                to 5 PM?</p>
              <div class="mt-2">
                <span
                  class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-orange-100 dark:bg-orange-900/30 text-orange-600 uppercase">Meal
                  Logged</span>
              </div>
            </div>
            <div class="shrink-0 flex flex-col items-center gap-1">
              <span
                class="h-5 w-5 rounded-full bg-primary flex items-center justify-center text-[10px] font-bold text-slate-900">2</span>
            </div>
          </div>

          <div
            class="p-4 flex items-start gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer border-b border-slate-100 dark:border-slate-800 opacity-70">
            <div class="relative shrink-0">
              <img class="h-12 w-12 rounded-full object-cover grayscale" data-alt="Client profile image of Sarah"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBnE8zsEuvmCoMBIN30RWpnJ8bOJ5M_Y-s34fEGUG23cwbGQ1dyiDtiWlecD6PAOU87sSznPyv61OGYGlOmvgyuQzKKHH5YxspOwNkTim4zj0DaGcGGc7mXjQuK85X5qbXABZiId8tERrluu_zpI1ORDHcxaM43uGlfx2VEJk3GVTDXLzw8ERsHRqAOV20Z0l06xtioQ86b1EwGk78HSQvEYbylroJWB2fZgNYrO0MhHQHaXxiuokIVKuR4EMpLeQTsNbrWrzVntU4" />
            </div>
            <div class="flex-1 min-w-0">
              <div class="flex justify-between items-baseline">
              ...
              <p class="text-xs text-slate-500 dark:text-slate-400 truncate mt-0.5">The meal plan is working really well
                so far!</p>
            </div>
          </div>
          ...
          <div
            class="p-4 flex items-start gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer border-b border-slate-100 dark:border-slate-800">
            <div class="relative shrink-0">
              <img class="h-12 w-12 rounded-full object-cover" data-alt="Client profile image of David"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDb2dOuTTOl_XbuTlOGtLP4PCcjFBL_Q3gTUuYFst19PustxpnUUOUCu8cdeffsQDBuiauJeiL5waeKeXtENeKumzsWdqgKwMPuCyIBCMHNcir2kG05TIayw_m3U1NrIxDLb2vvZq2VqnNtLEaVwBrJjr-NMRFdoVfl5cLeISn0ua3l_bUxterDWvCZmY7efQ_tefltDVHU72Dvk7ZNHcR9SX9OYM4w4I3FWUzPFm0zKTZzZh2phckSaa7cnrRR1cMxqS25lnPM_-k" />
            </div>
            <div class="flex-1 min-w-0">
              <div class="flex justify-between items-baseline">
              ...
              <p class="text-xs text-slate-500 dark:text-slate-400 truncate mt-0.5">Injury update: My knee is feeling
                much better.</p>
              <div class="mt-2">
                <span
                  class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-red-100 dark:bg-red-900/30 text-red-600 uppercase">High
                  Priority</span>
              </div>
            </div>
          </div>
